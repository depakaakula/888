    ...
    private void getFirebaseData(){
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                Log.d("MAP_TAG", currentLocation.getLatitude().toString());
                Log.d("MAP_TAG", currentLocation.getLongitude().toString());
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerVIewItemClickListener(getApplicationContext(), recyclerView, new RecyclerOnItemClickListener() {
                    @Override public void onItemClick(View view, int position) {
                        ...
                        Toast.makeText(getApplicationContext(), item.getLocation(), Toast.LENGTH_LONG).show();
                    }
