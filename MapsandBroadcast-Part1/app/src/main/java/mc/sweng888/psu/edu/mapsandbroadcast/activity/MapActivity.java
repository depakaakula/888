...
public class MapActivity extends Activity implements OnMapReadyCallback{
     ...
     *
     * @param latLng*/
    private void mapCameraConfiguration(GoogleMap latLng){

        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(currentLatLng) // the location that the camera is pointing at.
        ...
        mMap.addMarker(createCustomMapMarkersFromLocation(currentLatLng));
